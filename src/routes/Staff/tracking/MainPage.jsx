  ...
  if (error) {
    return (
      <div className="space-y-5 px-6 pb-5 pt-4 overflow-visible">
        ...
        >
          <WashingMachine size={22} style={{ color: isDarkMode ? '#F3EDE3' : '#0B2B26' }} />
        ...
        >
          <div className="text-center">
            ...
            <motion.button
              ...
              className="rounded-lg px-4 py-2 font-medium transition-all flex items-center gap-2 mx-auto"
              style={{
    ...
    <div className="space-y-5 px-6 pb-5 pt-4 overflow-visible">
      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={() => fetchData(true)}
            className="rounded-lg px-4 py-2 font-medium transition-all flex items-center gap-2"
            style={{
              backgroundColor: isDarkMode ? "#18442AF5" : "#0B2B26",
              color: "#F3EDE3",
            }}
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          {
            label: "Active Loads",
            value: jobs.reduce((acc, job) => acc + job.loads.filter(load => 
              load.status === "WASHING" || load.status === "DRYING").length, 0),
            color: "#60A5FA",
          ...
          },
          {
            ...
            value: jobs.reduce((acc, job) => acc + job.loads.filter(load => 
              load.status === "COMPLETED").length, 0),
            color: "#10B981",
      ...
      {jobs.length > 0 && (
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="flex flex-col items-center justify-between border-t p-4 sm:flex-row rounded-xl border-2"
          style={{
            backgroundColor: isDarkMode ? "#F3EDE3" : "#FFFFFF",
            borderColor: isDarkMode ? "#2A524C" : "#0B2B26",
          }}
        >
          <div className="mb-4 flex items-center space-x-2 sm:mb-0">
            <p className="text-sm" style={{ color: isDarkMode ? '#13151B' : '#0B2B26' }}>
              Rows per page
            </p>
            <select
          ...
          <div className="flex items-center space-x-2">
            <div className="text-sm font-medium" style={{ color: isDarkMode ? '#13151B' : '#0B2B26' }}>
