  ...
  return (
    <div className="space-y-6 overflow-visible px-6 pb-6 pt-4">
      ...
      <div className="space-y-2">
        ...
        <div ref={washerRef} className="relative z-0 overflow-x-auto scroll-smooth px-4 py-2">
          <div
      ...
      <div className="space-y-2">
        ...
        <div ref={dryerRef} className="relative z-0 overflow-x-auto scroll-smooth px-4 py-2">
          <div
            className="flex flex-nowrap gap-4"
            style={{
