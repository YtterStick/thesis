        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3 absolute left-1/2 transform -translate-x-1/2 md:static md:left-auto md:transform-none">
              <div className="w-9 h-9 rounded-lg flex items-center justify-center shadow-lg transition-colors"
                style={{
              ...
              <span className="font-deathstar text-xl tracking-wider transition-colors"
                style={{
                  color: isDarkMode ? '#F3EDE3' : '#0B2B26'
                }}>
                STAR WASH
            ...
            <nav className="hidden md:flex items-center space-x-8">
              {navItems.map((item) => (
                <a 
                  ...
                  className="transition-colors text-base font-medium hover:opacity-80"
                  style={{
                    color: isDarkMode ? '#F3EDE3' : '#0B2B26',
                    borderBottom: activeSection === item.href.replace('#', '') ? '2px solid' : 'none',
                    borderColor: isDarkMode ? '#F3EDE3' : '#0B2B26'
                  }}
                >
                  {item.label}
                </a>
              ...
              <nav className="flex flex-col p-6 space-y-6">
                {navItems.map((item) => (
                  <a
                    ...
                    href={item.href}
                    onClick={() => handleNavClick(item.href, item.label)}
                    className="transition-colors text-lg font-medium py-2 border-b hover:opacity-80"
                    style={{
                      color: isDarkMode ? '#F3EDE3' : '#0B2B26',
                      borderColor: isDarkMode ? '#1C3F3A' : '#0B2B26'
                    }}
