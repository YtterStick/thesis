...
const DashboardPage = () => {
  ...
  Here is today’s report and performance overview.
</p>
              ...
              <AreaChart data={overviewData} margin={{ top: 0, right: 0, left: 0, bottom: 0 }}>
                <defs>
                  <linearGradient id="colorLoad" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#3DD9B6" stopOpacity={0.8} />
                    <stop offset="95%" stopColor="#008B76" stopOpacity={0} />
                  </linearGradient>
                </defs>
                <Tooltip
                  cursor={false}
        ...
        <div className="card col-span-1 md:col-span-2 lg:col-span-3">
          ...
          <div className="card-body h-[300px] overflow-auto p-0">
            {recentSalesData.map((sale) => (
              <div
                key={sale.id}
                className="flex items-center justify-between gap-x-4 py-2 pr-2 border-b border-slate-200 dark:border-slate-700 last:border-none"
              >
